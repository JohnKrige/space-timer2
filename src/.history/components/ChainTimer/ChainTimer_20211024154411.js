...
const timerReducer = (state, action) => {
    switch (action.type) {
        ...
        case 'NEXT': {
            const nextTimer = Math.max(state.currentTimer + 1, state.timers.length -1);
            const arrCopy = [...state.timers];
        ...
        <TimerPage align="flex-start">
            <div>
                <ButtonsBar>
                    ...
                    <Button onClick={() => console.log()} color="blue"><FontAwesomeIcon icon={faStepBackward} /></Button>
                    <Button onClick={() => console.log()} color="blue"><FontAwesomeIcon icon={faStepForward} /></Button>
                    <Button onClick={() => console.log()} color="pink"><FontAwesomeIcon icon={faPlus} /></Button>
                    <Button onClick={() => console.log()} color="red"><FontAwesomeIcon icon={faVolumeMute} /></Button>
