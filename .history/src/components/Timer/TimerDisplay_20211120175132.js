...
import { MainTimerContainer, MainTimeDisplay, MainTimeDisplayComponent, TimeDisplaySection, TimerFace, DisplayMs} from './styles';
    ...
    return (
        <MainTimerContainer>
            ...
            <MainTimeDisplay marginBottom={props.type === "stopwatch" ? 5 : 30}>
                ...
                <Button onClick={() => props.setRunTimer(prev => !prev)} color="blue"><FontAwesomeIcon icon={!props.runTimer ? faPlay : faPause} /></Button>
