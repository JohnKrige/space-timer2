...
import { ModalContainer, ModalContent, TimeInput, TimeInputs, CloseModal, ModalBackground } from '../CountdownTimer/modalStyles';
...
const SetTimerModal = ({ onSubmit, totalTime, show, type="main", repeatTime=0, onClose }) => {
