...
import { ButtonsBar, ChainTimerPage, DeleteError, AccordionContainer, AccordionBody } from "./chainTimerStyles";
    ...
    const accordionBody = (
        <AccordionBody>
            <p>
                ...
                will automatically start. Each timer's name and time duration is customizable. Workouts are a good example of how the chain timer can come in handy. You may want to
                do 60 seconds of squats, then rest for 15 seconds and move on to 45 seconds of calf raises. You get the picture. Set the chain timer and press done to get started.
            </p>
        </AccordionBody>
    );
