                ...
                {edit ? (
                    ...
                    <>
                        <ButtonsBar>
                            ...
                            {!done ? (
                                <ChainTimerItem name={currentName} currentItem={currentNumber + 1} totalItems={totalTimers} mins={minutes} secs={seconds} NextItemName={nextTimer.name} isLast={currentTimer.index - nextTimer.index === 0}/>
                            )
                                :
                            (
                                <div>Done!</div>
