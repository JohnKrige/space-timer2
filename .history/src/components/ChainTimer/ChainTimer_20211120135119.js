                ...
                {edit ? (
                    ...
                    <>
                        <ButtonsBar>
                            ...
                            {!done ? (
                                <ChainTimerItem name={currentName} currentItem={currentNumber + 1} totalItems={totalTimers} mins={minutes} secs={seconds} NextItemName={nextTimer.name} isLast={currentNumber === timerState.timers.length}/>
                            )
                                :
                            (
                                <div>Done!</div>
