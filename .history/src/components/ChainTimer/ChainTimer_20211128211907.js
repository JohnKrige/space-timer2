...
import { ButtonsBar, ChainTimerPage, DeleteError, AccordionContainer, AccordionBody, WhatIs, Message, Done } from "./chainTimerStyles";
...
const ChainTimer = () => {
    ...
    const accordionTitle = <h3 style={{textDecoration: 'underline'}}>What is a chain timer?</h3>;
    const accordionBody = (
        <AccordionBody>
            <WhatIs>
                <p>
                    The chain timer consists of many timers that run consecutively (like a chain reaction). 
                </p><br />
                <h6>How to use it?</h6><br />
                <p>
                    If you are not on the "Set chain timer" page, hit the edit (pen) button. <br /><br />
                    Add new timers (hit the huge blue + sign) and give the activities a name and set the time. You can edit, delete and move existing timers.
                    When you are finished setting it up, hit "Done" and you are good to go. 
                </p><br />
            </WhatIs>
        </AccordionBody>
    );
        ...
        <TimerPage justify="flex-start">
            ...
            {started && 
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <Message duration="800">Started</Message>
                </div>}
            <AccordionContainer>
            ...
            <ChainTimerPage>
                {edit ? (
                    ...
                    <>
                        <ButtonsBar>
                                {!done && <Button onClick={() => setRunTimer(prev => !runTimer)} color="blue"><FontAwesomeIcon icon={!runTimer ? faPlay : faPause} /></Button>}
                            ...
                            <Button onClick={() => setEdit(true)} color="red"><FontAwesomeIcon icon={faEdit} /></Button>
