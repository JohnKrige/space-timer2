...
import { ButtonsBar, ChainTimerPage, DeleteError, AccordionContainer, AccordionBody, WhatIs, Message } from "./chainTimerStyles";
...
const ChainTimer = () => {
    ...
    useEffect(() => {
        ...
        if (runTimer && timeElapsed === 0) setStarted(true);
        ...
        <TimerPage justify="flex-start">
            ...
            {started && 
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <Message duration="1000">Started</Message>
                </div>}
            <AccordionContainer>
