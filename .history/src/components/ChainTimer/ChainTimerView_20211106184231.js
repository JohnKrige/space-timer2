...
import { ChainItemContainer, TimeDisplay, TimeDisplayContainer, ChainItemBackground, TimeDisplayLabel, MoveLabel, DeleteButton, NameLabel, ChainItemButtons } from "./chainTimerStyles";
        ...
        <ChainItemContainer isActive={props.isActive}>
            <ChainItemBackground>
                ...
                <ChainItemButtons>
                    ...
                    <DeleteButton onClick={() => props.remove(props.index)}><FontAwesomeIcon icon={faEdit} /></DeleteButton>
                </ChainItemButtons>
            </ChainItemBackground>
        </ChainItemContainer>
    )
