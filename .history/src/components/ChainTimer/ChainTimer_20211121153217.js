...
import { ButtonsBar, ChainTimerPage } from "./chainTimerStyles";
...
const timerReducer = (state, action) => {
    switch (action.type) {
        ...
        case 'REMOVE': {
            console.log(state.timers.length === 1);
            ...
            return {
                state,
                deleteError: "There must be at least one item. You can always edit it."
            };
        }
        case 'RESET': {
