        ...
        <AccordionBody>
            <WhatIs>
                ...
                <p>
                    ...
                    do 60 seconds of squats, then rest for 15 seconds and move on to 45 seconds of calf raises etc (you get the picture).
                </p><br />
                <p>Set the chain timer and press done to get started.</p>
            </WhatIs>
        </AccordionBody>
    );
