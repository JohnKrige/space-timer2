...
const Timer = props => {
    ...
    const [hours, setHours] = useEffect();
    const [minutes, setMinutes] = useEffect();
    const [seconds, setSeconds] = useEffect();
    ...
    useEffect(() => {
        setHours(Math.floor(props.duration / 3600000));
        setMinutes(Math.floor((props.duration - 3600000 * hours) / 60000));
        setSeconds(Math.floor((props.duration - (3600000 * hours) - 60000 * minutes) / 1000));
    }, []);
