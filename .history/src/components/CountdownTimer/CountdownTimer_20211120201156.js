...
import { CountdownTimerContainer } from './countdownTimerStyles';
...
const CountdownTimer = () => {
    ...
    return (
        <TimerPage justify="start">
            <h1 className="PageTitle" style={{marginBottom: '40px'}}>Countdown timer</h1>
            <CountdownTimerContainer style={{ display: 'flex', height: '100%', alignItems: 'end' }}>
