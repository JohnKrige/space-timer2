...
const Timer = props => {
    ...
    useEffect(() => {
        setHours(Math.floor(timeRemaining / 3600000));
        setMinutes(Math.floor((timeRemaining - 3600000 * hours) / 60000));
        setSeconds(Math.floor((timeRemaining - (3600000 * hours) - 60000 * minutes) / 1000));
    }, []);
