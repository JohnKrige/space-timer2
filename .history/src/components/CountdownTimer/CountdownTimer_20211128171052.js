...
import { CountdownTimerContainer, Header, Started, HeaderContainer } from './countdownTimerStyles';
...
const CountdownTimer = () => {
    ...
    const timerCompleted = () => {
        ...
        setTimeout(() => setShowCompletedMessage(false), 4900);
        if (muteMain) return;
        audioFinal.play();
    };
    ...
    return (
        <TimerPage justify="start">
            <HeaderContainer>
                ...
                {showCompletedMessage && <Started>Started</Started>}
            </HeaderContainer>
