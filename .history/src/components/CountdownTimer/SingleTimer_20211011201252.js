...
const Timer = props => {
    ...
    return (
        <SingleTimerContainer>
            ...
            {runTimer
                ? <Button onClick={onPauseHandler} color={"blue"}>
                    <div style={{ backgroundColor: "black", color: "white", borderRadius: "15%"}}>pause</div>
                </Button>
                : <Button onClick={onStartHandler} color={"blue"}>
                    <div style={{ backgroundColor: "black", color: "white", padding: "8px", borderRadius: "15%"}}>start</div>
                </Button>
            }
