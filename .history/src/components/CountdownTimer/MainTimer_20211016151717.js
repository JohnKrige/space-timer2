...
import { MainTimerContainer, MainTimeDisplay, MainTimeDisplayComponent, TimeDisplaySection, TimerFace, faVolumeMute } from './styles';
...
const MainTimer = (props) => {
    ...
    return (
        <MainTimerContainer>
            ...
            <Button onClick={() => props.onEdit()}><FontAwesomeIcon icon={faEdit} color="pink"/></Button>
